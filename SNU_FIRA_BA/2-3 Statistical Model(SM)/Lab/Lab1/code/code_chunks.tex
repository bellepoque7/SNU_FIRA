...
To display the output of a code chunk but not the underlying R code, you
specify the echo=FALSE option:
...
\includegraphics{code_chunks_files/figure-latex/unnamed-chunk-3-1.pdf}
